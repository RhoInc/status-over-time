...
.wc-webtable table:not(.table){
	font-size: .9em;
}
.wc-webtable table:not(.table) th{
	padding: 1em 2em 1em 0;
	border-bottom: 1px solid #ccc;
}
.wc-webtable table:not(.table) td{
	padding: 1em 2em 1em 0;
...
.wc-controls .control-group .control-label{
	/*font-weight: bold;*/
	display: block;
}

.wc-controls .control-group.inline .control-label{
	display: inline;
	margin-right: .5em;
}
...
.wc-controls .control-group .control-label + .changer{
	margin-top: 2px;
}

.wc-controls .control-group .control-label.inline{
	display: inline;
	margin-right: .5em;
}

.wc-controls .control-group .control-label .label-required{
	color: #de2d26;
	padding: 0 .25em;
	border: 1px solid;
	margin-left: .5em;
